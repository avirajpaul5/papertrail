...
function Explore() {
  ...
  const [filteredNewsletters, setFilteredNewsletters] = useState<Newsletter[]>(newsletters);
  ...
  return (
    <div ref={pageRef} className="container-wide py-8 md:py-12">
      ...
      {/* Main Content */}
      <div className="mt-12">
        <h1 className="text-3xl md:text-4xl font-semibold mb-8">Explore Newsletters</h1>
